...
i.styles(Object.merge({},h.from,{position:"absolute"}));f.styles(Object.merge({},h.to,{"z-index":1,position:"relative"}));e.styles(Object.merge({},h.from,g));
if(Browser.ie&&Browser.version<9){e.set("morph",{link:"cancel",duration:this.options.duration.toInt(),transition:"quad:in:out",onComplete:function(){e.styles(Object.merge({},h.to,{position:"relative"}));
